use crate::common::{
    u8_high_low_get_u16, u16_get_u8_high, u16_get_u8_low, INDEX_VOLTAGE_HIGH,
    INDEX_VOLTAGE_LOW, MESSAGE_LENGTH,
};
...
pub fn set(voltage_mv: u16, message: &mut [u8; MESSAGE_LENGTH]) {
    ...
    message[INDEX_VOLTAGE_HIGH] = u16_get_u8_high(command_voltage_value_mv_by10);
    message[INDEX_VOLTAGE_LOW] = u16_get_u8_low(command_voltage_value_mv_by10);
}
